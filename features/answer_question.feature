Feature: Answer Question
  In order to know what is the profile of my company
  As a user
  I want to respond each question

  Scenario: Answer question 2.A.1, example 1
  ...
  Scenario: Answer question 2.A.1, example 2
    Given an empty score
    When I answer the ordinal question "2.A.1" with:
      | A | 6 |
      | B | 5 |
  ...
  Scenario: Answer question 2.A.2, example 1
    Given an empty score
    ...
    Then my current score should be:
      ...
      | social-startup            | 0.2  |
      | social-growing            | 0.2  |
      | social-consolidation      | 0.2  |
      | high_impact-startup       | 0.16 |
      | high_impact-growing       | 0.16 |
      | high_impact-consolidation | 0.16 |

  Scenario: Answer question 2.A.2, example 2
    Given an empty score
    When I answer the ordinal question "2.A.2" with:
      | A | 6 |
      | B | 5 |
